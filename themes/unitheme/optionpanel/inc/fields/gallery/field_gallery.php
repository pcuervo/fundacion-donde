...
if ( ! class_exists( 'ReduxFramework_gallery' ) ) {
    ...
    class ReduxFramework_gallery {
        ...
        public function render() {
            ...
            echo '</div>';
            echo '<a href="#" onclick="return false;" id="edit-gallery" class="gallery-attachments button button-primary">' . esc_html__( 'Add/Edit Gallery', 'reduxframework' ) . '</a> ';
            echo '<a href="#" onclick="return false;" id="clear-gallery" class="gallery-attachments button">' . esc_html__( 'Clear Gallery', 'reduxframework' ) . '</a>';
