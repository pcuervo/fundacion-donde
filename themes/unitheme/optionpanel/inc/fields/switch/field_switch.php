...
if ( ! class_exists( 'ReduxFramework_switch' ) ) {
    class ReduxFramework_switch {
        ...
        function render() {
            ...
            //Label ON
            $this->field['on'] = isset( $this->field['on'] ) ? $this->field['on'] : esc_html__( 'On', 'reduxframework' );

            //Label OFF
            $this->field['off'] = isset( $this->field['off'] ) ? $this->field['off'] : esc_html__( 'Off', 'reduxframework' );
