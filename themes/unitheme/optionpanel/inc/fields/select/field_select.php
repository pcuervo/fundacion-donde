    ...
    class ReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'reduxframework' );
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'reduxframework' ) . '</strong>';
            }
        } //function
