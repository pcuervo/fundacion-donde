    ...
    class Redux_Welcome {
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'reduxframework' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            $page(
                esc_html__( 'Welcome to Redux Framework', 'reduxframework' ), esc_html__( 'Redux Framework', 'reduxframework' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            $page(
                esc_html__( 'Redux Framework Changelog', 'reduxframework' ), esc_html__( 'Redux Framework Changelog', 'reduxframework' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Get Support', 'reduxframework' ), esc_html__( 'Get Support', 'reduxframework' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Redux Extensions', 'reduxframework' ), esc_html__( 'Redux Extensions', 'reduxframework' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            $page(
                esc_html__( 'The people that develop Redux Framework', 'reduxframework' ), esc_html__( 'The people that develop Redux Framework', 'reduxframework' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            $page(
                esc_html__( 'Redux Framework Status', 'reduxframework' ), esc_html__( 'Redux Framework Status', 'reduxframework' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                    ...
                    <?php esc_attr_e( "What's New", 'reduxframework' ); ?>
                    ...
                    <?php esc_attr_e( 'Extensions', 'reduxframework' ); ?>
                    ...
                    <?php esc_attr_e( 'Changelog', 'reduxframework' ); ?>
                    ...
                    <?php esc_attr_e( 'Support', 'reduxframework' ); ?>
                    ...
                    <?php esc_attr_e( 'Status', 'reduxframework' ); ?>
                </a>
            </h2>
        <?php
        }
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( esc_html__( 'View %s', 'reduxframework' ), esc_html($contributor->login) ) )
                );
