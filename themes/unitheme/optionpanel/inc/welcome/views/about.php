<div class="wrap about-wrap">
    <h1><?php printf( esc_html__( 'Welcome to Redux Framework %s', 'reduxframework' ), $this->display_version ); ?></h1>

    <div
        class="about-text"><?php printf( esc_html__( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'reduxframework' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
            class="el el-redux"></i><span><?php printf( esc_html__( 'Version %s', 'reduxframework' ), ReduxFramework::$_version ); ?></span>
    </div>
    ...
    <div id="redux-message" class="updated">
        <h4><?php _e( 'What is Redux Framework?', 'reduxframework' ); ?></h4>

        <p><?php _e( 'Redux Framework is the core of many products on the web. It is an option framework which developers use to
            enhance their products.', 'reduxframework' ); ?></p>

        <p class="submit">
            <a class="button-primary" href="<?php echo 'http://';?>reduxframework.com"
               target="_blank"><?php _e( 'Learn More', 'reduxframework' ); ?></a>
        </p>
    </div>

    <div class="changelog">

        <h2><?php _e( 'New in this Release', 'reduxframework' ); ?></h2>
